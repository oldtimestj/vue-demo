...
<html lang="en-US">
  <head>
    ...
    <title>Properties | Vue Grid Layout - ️A grid layout system for Vue.js</title>
    ...
    <meta property="article:modified_time" content="2020-10-12T15:01:42.000Z">
    ...
    <link rel="preload" href="/vue-grid-layout/assets/css/0.styles.921dc386.css" as="style"><link rel="preload" href="/vue-grid-layout/assets/js/app.d3ede5c3.js" as="script"><link rel="preload" href="/vue-grid-layout/assets/js/4.aca3d542.js" as="script"><link rel="preload" href="/vue-grid-layout/assets/js/3.24b3f532.js" as="script"><link rel="preload" href="/vue-grid-layout/assets/js/36.d279aff7.js" as="script"><link rel="prefetch" href="/vue-grid-layout/assets/js/1.15316f8a.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/10.4afa56b1.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/11.6020b6f3.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/12.4c1c2e81.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/13.5df86042.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/14.fab80ef4.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/15.16b8936c.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/16.7f320d43.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/17.443a9375.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/18.ba1f9f68.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/19.356a0e5f.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/20.f7e2e6ed.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/21.71ed7c14.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/22.ab50eaae.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/23.447db5ba.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/24.fc773d01.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/25.c9a41c15.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/26.faaad377.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/27.5ce6e047.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/28.b2f416ef.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/29.5c926b91.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/30.3a9fb9e0.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/31.a2c46fac.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/32.6202a77a.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/33.21e6d4fb.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/34.55378c69.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/35.1ee1d8bf.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/37.78d34f24.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/5.5c91e451.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/6.fd898fe1.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/7.0aa42431.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/8.9da7860c.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/9.569a1594.js">
...
<strong>This property is not reactive</strong></p> <h2 id="griditem"><a href="#griditem" class="header-anchor">#</a> GridItem</h2> <h3 id="i"><a href="#i" class="header-anchor">#</a> i</h3> <ul><li>type: <code>String</code></li> <li>required: <code>true</code></li></ul> <p>This is the unique identifier of the item.</p> <h3 id="x"><a href="#x" class="header-anchor">#</a> x</h3> <ul><li>type: <code>Number</code></li> <li>required: <code>true</code></li></ul> <p>Says what is a initial horizontal position of the item (in which column it should be placed).</p> <p>The value must be a <em>whole number</em>.</p> <h3 id="y"><a href="#y" class="header-anchor">#</a> y</h3> <ul><li>type: <code>Number</code></li> <li>required: <code>true</code></li></ul> <p>Says what is a initial vertical position of the item (in which row it should be placed).</p> <p>The value must be a <em>whole number</em>.</p> <h3 id="w"><a href="#w" class="header-anchor">#</a> w</h3> <ul><li>type: <code>Number</code></li> <li>required: <code>true</code></li></ul> <p>Says what is a initial width of the item.</p> <p>The value is a number that is multiplied by <code>colWidth</code>.</p> <h3 id="h"><a href="#h" class="header-anchor">#</a> h</h3> <ul><li>type: <code>Number</code></li> <li>required: <code>true</code></li></ul> <p>Says what is a initial height of the item.</p> <p>The value is a number that is multiplied by <code>rowHeight</code>.</p> <h3 id="minw"><a href="#minw" class="header-anchor">#</a> minW</h3> <ul><li>type: <code>Number</code></li> <li>required: <code>false</code></li> <li>default: <code>1</code></li></ul> <p>Says what is a minimal width of the item. If <code>w</code> will be smaller then <code>minW</code> then <code>w</code> will be set to <code>minW</code>.</p> <p>The value is a number that is multiplied by <code>colWidth</code>.</p> <h3 id="minh"><a href="#minh" class="header-anchor">#</a> minH</h3> <ul><li>type: <code>Number</code></li> <li>required: <code>false</code></li> <li>default: <code>1</code></li></ul> <p>Says what is a minimal hieght of the item. If <code>h</code> will be smaller then <code>minH</code> then <code>h</code> will be set to <code>minH</code>.</p> <p>The value is a number that is multiplied by <code>rowHeight</code>.</p> <h3 id="maxw"><a href="#maxw" class="header-anchor">#</a> maxW</h3> <ul><li>type: <code>Number</code></li> <li>required: <code>false</code></li> <li>default: <code>Infinity</code></li></ul> <p>Says what is a maximal width of the item. If <code>w</code> will be bigger then <code>maxW</code> then <code>w</code> will be set to <code>maxW</code>.</p> <p>The value is a number that is multiplied by <code>colWidth</code>.</p> <h3 id="maxh"><a href="#maxh" class="header-anchor">#</a> maxH</h3> <ul><li>type: <code>Number</code></li> <li>required: <code>false</code></li> <li>default: <code>Infinity</code></li></ul> <p>Says what is a maximal height of the item. If <code>h</code> will be bigger then <code>maxH</code> then <code>h</code> will be set to <code>maxH</code>.</p> <p>The value is a number that is multiplied by <code>rowHeight</code></p> <h3 id="isdraggable-2"><a href="#isdraggable-2" class="header-anchor">#</a> isDraggable</h3> <ul><li>type: <code>Boolean</code></li> <li>required: <code>false</code></li> <li>default: <code>null</code></li></ul> <p>Says if item is draggable.</p> <p>If default value is <code>null</code> then it's inherited from parent.</p> <h3 id="isresizable-2"><a href="#isresizable-2" class="header-anchor">#</a> isResizable</h3> <ul><li>type: <code>Boolean</code></li> <li>required: <code>false</code></li> <li>default: <code>null</code></li></ul> <p>Says if item is resizable.</p> <p>If default value is <code>null</code> then it's inherited from parent.</p> <h3 id="static"><a href="#static" class="header-anchor">#</a> static</h3> <ul><li>type: <code>Boolean</code></li> <li>required: <code>false</code></li> <li>default: <code>false</code></li></ul> <p>Says if item is static (won't be draggable, resizable or moved by other items).</p> <h3 id="dragignorefrom"><a href="#dragignorefrom" class="header-anchor">#</a> dragIgnoreFrom</h3> <ul><li>type: <code>String</code></li> <li>required: <code>false</code></li> <li>default: <code>'a, button'</code></li></ul> <p>Says which elements of the item shouldn't trigger drag event of the item.</p> <p>The value is <code>css-like</code> selector string.</p> <p>For more info please refer to <code>ignoreFrom</code> in <a href="http://interactjs.io/docs/#ignorable-selectors" target="_blank" rel="noopener noreferrer">interact.js docs<svg xmlns="http://www.w3.org/2000/svg" aria-labelledby="outbound-link-title" role="img" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><title id="outbound-link-title">(opens new window)</title> <path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg></a>.</p> <h3 id="dragallowfrom"><a href="#dragallowfrom" class="header-anchor">#</a> dragAllowFrom</h3> <ul><li>type: <code>String</code></li> <li>required: <code>false</code></li> <li>default: <code>null</code></li></ul> <p>Says which elements of the item should trigger drag event of the item.</p> <p>The value is <code>css-like</code> selector string.</p> <p>If <code>null</code> then one can drag by any (excluding <code>dragIgnoreFrom</code>) element of the item.</p> <p>For more info please refer to <code>allowFrom</code> in <a href="http://interactjs.io/docs/#ignorable-selectors" target="_blank" rel="noopener noreferrer">interact.js docs<svg xmlns="http://www.w3.org/2000/svg" aria-labelledby="outbound-link-title" role="img" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><title id="outbound-link-title">(opens new window)</title> <path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg></a>.</p> <h3 id="resizeignorefrom"><a href="#resizeignorefrom" class="header-anchor">#</a> resizeIgnoreFrom</h3> <ul><li>type: <code>String</code></li> <li>required: <code>false</code></li> <li>default: <code>'a, button'</code></li></ul> <p>Says which elements of the item shouldn't trigger resize event of the item.</p> <p>The value is <code>css-like</code> selector string.</p> <p>For more info please refer to <code>ignoreFrom</code> in <a href="http://interactjs.io/docs/#ignorable-selectors" target="_blank" rel="noopener noreferrer">interact.js docs<svg xmlns="http://www.w3.org/2000/svg" aria-labelledby="outbound-link-title" role="img" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><title id="outbound-link-title">(opens new window)</title> <path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg></a>.</p></div> <footer class="page-edit"><div class="edit-link"><a href="https://github.com/jbaysolutions/vue-grid-layout/edit/master/website/docs/guide/properties.md" target="_blank" rel="noopener noreferrer">Help improve this page!</a> <svg xmlns="http://www.w3.org/2000/svg" aria-labelledby="outbound-link-title" role="img" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><title id="outbound-link-title">(opens new window)</title> <path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg></div> <div class="last-updated"><span class="prefix">Last Updated:</span> <span class="time">10/12/2020, 4:01:42 PM</span></div></footer> <div class="page-nav"><p class="inner"><span class="prev">
    ...
    <script src="/vue-grid-layout/assets/js/app.d3ede5c3.js" defer></script><script src="/vue-grid-layout/assets/js/4.aca3d542.js" defer></script><script src="/vue-grid-layout/assets/js/3.24b3f532.js" defer></script><script src="/vue-grid-layout/assets/js/36.d279aff7.js" defer></script>
  </body>
</html>
