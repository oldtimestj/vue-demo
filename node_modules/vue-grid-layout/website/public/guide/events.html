...
<html lang="en-US">
  <head>
    ...
    <title>Events | Vue Grid Layout - ️A grid layout system for Vue.js</title>
    ...
    <link rel="preload" href="/vue-grid-layout/assets/css/0.styles.921dc386.css" as="style"><link rel="preload" href="/vue-grid-layout/assets/js/app.d3ede5c3.js" as="script"><link rel="preload" href="/vue-grid-layout/assets/js/4.aca3d542.js" as="script"><link rel="preload" href="/vue-grid-layout/assets/js/3.24b3f532.js" as="script"><link rel="preload" href="/vue-grid-layout/assets/js/34.55378c69.js" as="script"><link rel="prefetch" href="/vue-grid-layout/assets/js/1.15316f8a.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/10.4afa56b1.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/11.6020b6f3.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/12.4c1c2e81.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/13.5df86042.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/14.fab80ef4.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/15.16b8936c.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/16.7f320d43.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/17.443a9375.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/18.ba1f9f68.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/19.356a0e5f.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/20.f7e2e6ed.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/21.71ed7c14.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/22.ab50eaae.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/23.447db5ba.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/24.fc773d01.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/25.c9a41c15.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/26.faaad377.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/27.5ce6e047.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/28.b2f416ef.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/29.5c926b91.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/30.3a9fb9e0.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/31.a2c46fac.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/32.6202a77a.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/33.21e6d4fb.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/35.1ee1d8bf.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/36.d279aff7.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/37.78d34f24.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/5.5c91e451.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/6.fd898fe1.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/7.0aa42431.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/8.9da7860c.js"><link rel="prefetch" href="/vue-grid-layout/assets/js/9.569a1594.js">
  ...
  Changelog
    ...
    GitHub
    <svg xmlns="http://www.w3.org/2000/svg" aria-labelledby="outbound-link-title" role="img" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><title id="outbound-link-title">(opens new window)</title> <path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg></a></nav>  <ul class="sidebar-links"><li><section class="sidebar-group depth-0"><p class="sidebar-heading open"><span>Guide</span> <!----></p> <ul class="sidebar-links sidebar-group-items"><li><a href="/vue-grid-layout/guide/" aria-current="page" class="sidebar-link">Installation</a></li><li><a href="/vue-grid-layout/guide/usage.html" class="sidebar-link">Usage</a></li><li><a href="/vue-grid-layout/guide/properties.html" class="sidebar-link">Properties</a></li><li><a href="/vue-grid-layout/guide/events.html" aria-current="page" class="active sidebar-link">Events</a><ul class="sidebar-sub-headers"><li class="sidebar-sub-header"><a href="/vue-grid-layout/guide/events.html#gridlayout" class="sidebar-link">GridLayout</a></li><li class="sidebar-sub-header"><a href="/vue-grid-layout/guide/events.html#griditem" class="sidebar-link">GridItem</a></li></ul></li></ul></section></li><li><section class="sidebar-group depth-0"><p class="sidebar-heading"><span>Examples</span> <!----></p> <ul class="sidebar-links sidebar-group-items"><li><a href="/vue-grid-layout/guide/01-basic.html" class="sidebar-link">01 - Basic</a></li><li><a href="/vue-grid-layout/guide/02-events.html" class="sidebar-link">02 - Move and resize events</a></li><li><a href="/vue-grid-layout/guide/03-multiple-grids.html" class="sidebar-link">03 - Multiple grids</a></li><li><a href="/vue-grid-layout/guide/04-allow-ignore.html" class="sidebar-link">04 - Drag allow/ignore elements</a></li><li><a href="/vue-grid-layout/guide/05-mirrored.html" class="sidebar-link">05 - Mirrored grid layout</a></li><li><a href="/vue-grid-layout/guide/06-responsive.html" class="sidebar-link">06 - Responsive</a></li><li><a href="/vue-grid-layout/guide/07-prevent-collision.html" class="sidebar-link">07 - Prevent Collision</a></li><li><a href="/vue-grid-layout/guide/08-responsive-predefined-layouts.html" class="sidebar-link">08 - Responsive with predefined layouts</a></li><li><a href="/vue-grid-layout/guide/09-dynamic-add-remove.html" class="sidebar-link">09 - Dynamic Add/Remove</a></li><li><a href="/vue-grid-layout/guide/10-drag-from-outside.html" class="sidebar-link">10 - Drag From Outside</a></li></ul></section></li></ul> <footer class="footer" data-v-bdc456ae>
          A product by:
...
Moved and resized event listeners can be added, if the only notification needed is when an item is finished moving or resizing.</p> <p>Working example <a href="/vue-grid-layout/guide/02-events.html">here</a></p> <div class="language-html extra-class"><pre class="language-html"><code>
...
</code></pre></div><h2 id="gridlayout"><a href="#gridlayout" class="header-anchor">#</a> GridLayout</h2> <ul><li><p><strong>layoutCreatedEvent</strong></p> <p>Layout created event</p> <p>Emited on the component created lifecycle hook</p></li></ul> <div class="language-javascript extra-class"><pre class="language-javascript"><code>    <span class="token function-variable function">layoutCreatedEvent</span><span class="token operator">:</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token parameter">newLayout</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
...
</code></pre></div><ul><li><p><strong>layoutBeforeMountEvent</strong></p> <p>Layout beforeMount event</p> <p>Emited on the component beforeMount lifecycle hook</p></li></ul> <div class="language-javascript extra-class"><pre class="language-javascript"><code>    <span class="token function-variable function">layoutBeforeMountEvent</span><span class="token operator">:</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token parameter">newLayout</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
</code></pre></div><ul><li><p><strong>layoutMountedEvent</strong></p> <p>Layout mounted event</p> <p>Emited on the component mounted lifecycle hook</p></li></ul> <div class="language-javascript extra-class"><pre class="language-javascript"><code>    <span class="token function-variable function">layoutMountedEvent</span><span class="token operator">:</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token parameter">newLayout</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
</code></pre></div><ul><li><p><strong>layoutReadyEvent</strong></p> <p>Layout ready event</p> <p>Emited when all the operations on the mount hook finish</p></li></ul> <div class="language-javascript extra-class"><pre class="language-javascript"><code>    <span class="token function-variable function">layoutReadyEvent</span><span class="token operator">:</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token parameter">newLayout</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
</code></pre></div><ul><li><p><strong>layoutUpdatedEvent</strong></p> <p>Layout updated event</p> <p>Every time the layout has finished updating and positions of all grid-items are recalculated</p></li></ul> <div class="language-javascript extra-class"><pre class="language-javascript"><code>    <span class="token function-variable function">layoutUpdatedEvent</span><span class="token operator">:</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token parameter">newLayout</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
</code></pre></div><ul><li><p><strong>breakpointChangedEvent</strong></p> <p>Breakpoint Changed event</p> <p>Every time the breakpoint value changes due to window resize</p></li></ul> <div class="language-javascript extra-class"><pre class="language-javascript"><code>    <span class="token comment">/**
     * 
...
</code></pre></div><h2 id="griditem"><a href="#griditem" class="header-anchor">#</a> GridItem</h2> <ul><li><p><strong>moveEvent</strong></p> <p>Move event</p> <p>Every time an item is being moved and changes position</p></li></ul> <div class="language-javascript extra-class"><pre class="language-javascript"><code>    <span class="token function-variable function">moveEvent</span><span class="token operator">:</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token parameter">i<span class="token punctuation">,</span> newX<span class="token punctuation">,</span> newY</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span><span class="token punctuation">,</span>
</code></pre></div><ul><li><p><strong>movedEvent</strong></p> <p>Moved event</p> <p>Every time an item is finished being moved and changes position</p></li></ul> <div class="language-javascript extra-class"><pre class="language-javascript"><code>    <span class="token function-variable function">movedEvent</span><span class="token operator">:</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token parameter">i<span class="token punctuation">,</span> newX<span class="token punctuation">,</span> newY</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span><span class="token punctuation">,</span>
</code></pre></div><ul><li><p><strong>resizedEvent</strong></p> <p>Resized event</p> <p>Every time an item is finished being resized and changes size</p></li></ul> <div class="language-javascript extra-class"><pre class="language-javascript"><code>    <span class="token comment">/**
     * 
    ...
    <span class="token punctuation">}</span><span class="token punctuation">,</span>
</code></pre></div><ul><li><p><strong>containerResizedEvent</strong></p> <p>Container Resized event</p> <p>Every time the grid item/layout container changes size (browser window or other)</p></li></ul> <div class="language-javascript extra-class"><pre class="language-javascript"><code>    <span class="token comment">/**
     * 
     * @param i the item id/index
     * @param newH new height in grid rows 
     * @param newW new width in grid columns
    ...
    <span class="token punctuation">}</span><span class="token punctuation">,</span>
      ...
      <a href="/vue-grid-layout/guide/properties.html" class="prev">
        Properties
      </a></span> <span class="next"><a href="/vue-grid-layout/guide/01-basic.html">
        01 - Basic
      </a>
      →
    </span></p></div> </main></div><div class="global-ui"><!----></div></div>
    <script src="/vue-grid-layout/assets/js/app.d3ede5c3.js" defer></script><script src="/vue-grid-layout/assets/js/4.aca3d542.js" defer></script><script src="/vue-grid-layout/assets/js/3.24b3f532.js" defer></script><script src="/vue-grid-layout/assets/js/34.55378c69.js" defer></script>
  </body>
</html>
