...
var PickingService = (_dec = injectable(), _dec2 = inject(TYPES.IRendererService), _dec3 = inject(TYPES.IGlobalConfigService), _dec4 = inject(TYPES.IInteractionService), _dec5 = inject(TYPES.ILayerService), _dec(_class = (_class2 = (_temp = function () {
  ...
  _createClass(PickingService, [{
    ...
    key: "pickingAllLayer",
    value: function () {
      var _pickingAllLayer = _asyncToGenerator(_regeneratorRuntime.mark(function _callee(target) {
    ...
    key: "pickingLayers",
    value: function () {
      var _pickingLayers = _asyncToGenerator(_regeneratorRuntime.mark(function _callee2(target) {
        var _this2 = this;
