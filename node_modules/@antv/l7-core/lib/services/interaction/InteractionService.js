...
var InteractionService = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_types.TYPES.IMapService), _dec3 = (0, _inversify.inject)(_types.TYPES.ILogService), _dec(_class = (_class2 = (_temp = function (_EventEmitter) {
  ...
  function InteractionService() {
    ...
    _this.$containter = void 0;

    _this.onDrag = function (target) {
    ...
    _this.onHammer = function (target) {
  ...
  (0, _createClass2.default)(InteractionService, [{
    ...
    value: function addEventListenerOnMap() {
      ...
      if ($containter) {
        var hammertime = new _hammerjs.default.Manager($containter);
        hammertime.add(new _hammerjs.default.Tap({
          event: 'dblclick',
          taps: 2
        }));
        hammertime.add(new _hammerjs.default.Tap({
        ...
        hammertime.add(new _hammerjs.default.Pan({
          threshold: 0,
          pointers: 0
        }));
        hammertime.add(new _hammerjs.default.Press({}));
